 ...
 *
 * Requires an existing session in tests/auth_qr or tests/auth_pairing.
 * Run test-qr.js or test-pairing.js first to authenticate.
 *
 * This test connects and sends a text message to yourself,
 * then sends an image, a reaction, and waits for a reply.
 *
